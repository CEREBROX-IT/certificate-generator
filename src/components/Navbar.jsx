...
const Navbar = () => {
    ...
    return (
        ...
        >
            <section className="flex flex-row items-center  md:ml-6"
            onClick={()=>{
                navigate("/")
            }}
            >   
            <img src={BridgetteLogo} className="h-[40px] w-[40px] md:h-[45px] md:w-[45px]"/> 
            <p className="font_sansita font-bold text-[21px] md:text-[26px] ml-2">BRIDGETTE</p>
            </section>

          ...
          <div className="fixed inset-0 bg-black bg-opacity-10 flex items-center justify-center z-40">
            ...
            >
              <div className="flex flex-row items-center">
                <p className="text-center w-full font-bold text-[28px]">INPUT DETAILS</p>
                <button className="r-btn cursor-pointer rounded-[50%] hover:bg-slate-200 z-10 mt-[-2rem] mr-[-0.5rem]"
                 onClick={()=>{
                  closeModal();
                 }}
                >
              ...
              <form className="h-full z-10 " onSubmit={handleSubmit(onSubmit)}>
                <div className="w-full mt-4 h-[85%] overflow-y-auto px-1 py-2" >
                 <div className="mb-3 w-full">
                    <TextField label="Awardee Name" variant="outlined" 
                        name="awardee_name"
                        className="w-full"
                        inputProps={{
                        style:{
                    ...
                    />
                  <p className="ml-1 mt-1 text-[13px] text-red-500">This is required.</p>
                 </div>
                 <div className="flex flex-col md:flex-row w-full md:gap-4">
                 <div className="mb-3 w-full">
                    <TextField label="Grade Level" variant="outlined" 
                        name="grade_level"
                        className="w-full"
                        inputProps={{
                        style:{
                 ...
                 <div className="flex flex-col md:flex-row w-full md:gap-4">
                 <div className="mb-3 w-full">
                    <TextField label="Average" variant="outlined" 
                        name="average"
                        className="w-full"
                        inputProps={{
                        style:{
                 ...
                 <div className="w-full border-t-[2px] border-[#C4C4C4]">
                   <div className="mb-3  mt-4 w-full">
                    <p className="font-bold text-[14px] mb-1">Signature Attachment</p>
                      <input className="border-[1.5px] rounded-[5px] border-[#C4C4C4] h-[48px] p-[8px] w-full hover:border-black"
                       type="file"
                       />
                      <p className="ml-1 mt-1 text-[13px] text-red-500">This is required.</p>
                  </div>
                  <div className="mb-3 w-full">
                    <TextField label="Signatory Name" variant="outlined" 
                        name="signatory"
                        className="w-full"
                        inputProps={{
                        style:{
                 ...
                 <div className="mb-3 w-full">
                    <TextField label="Signatory Position" variant="outlined" 
                        name="signatory"
                        className="w-full"
                        inputProps={{
                        style:{
                ...
                <button className="r-btn py-2 bg-[#F5D45E] w-[150px] text-white font-bold rounded-md" type="submit"
                 onClick={()=>{
                  console.log("click")
                 }}
                 >
